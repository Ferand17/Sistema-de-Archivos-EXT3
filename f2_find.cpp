...
f2_find::f2_find(Lista_Particiones *lista, int *idUsuario, QString *usuario, QString *id_mount, QString *grupo, int *idGrupo, nodo_particiones *part_global){
    this->lista=lista;
...
void f2_find::ast_find(QList<Nodo_arbol> *hijos){
    string log_error="";
...
void f2_find::ejecutar_find(QString ppath, QString pname){
...
string f2_find::ReplaceAll(string str, const string& from, const string& to){
    size_t start_pos = 0;
